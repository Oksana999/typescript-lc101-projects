...
//console.log(`${spacecraftName} needs ${getDaysToLocation(kilometersToMars)} days to fly to Mars `);
//console.log(`${spacecraftName} needs ${getDaysToLocation(kilometersToTheMoon)} days to fly to the Moon `);
